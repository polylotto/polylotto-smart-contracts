    ...
    Ownable
{
    ...
    function startRaffle() public stateCheck {
        //initiating raffle
        raffleID++;
    ...
    function updateWinnersPayouts(RaffleCategory _category) public {
        RaffleStruct storage _raffle = raffles[_category][raffleID];
    ...
    function payoutWinners(RaffleCategory _category) public {
        RaffleStruct storage _raffle = raffles[_category][raffleID];
        RaffleData storage _raffleData = rafflesData[_category];
    ...
    function rollover(RaffleCategory _category, bool _deactivated) public {
        RaffleStruct storage _raffle = raffles[_category][raffleID];
        if (!_deactivated) {
            setRaffleState(_category, RaffleState.WAITING_FOR_REBOOT);
            rebootChecker++;
